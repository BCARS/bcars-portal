...
Short, dated records of decisions that shape the portal. Each ADR is one
page. Statuses: Proposed, Accepted, Superseded (with reference), Deprecated.

Rationale for a decision belongs here; day-to-day design detail belongs in
`../phase-1-design.md`.

| ID | Status | Title |
| --- | --- | --- |
| 0000 | Proposed | License selection |
...
| 0015 | Accepted | An imported contact detail is published to the member directory |
